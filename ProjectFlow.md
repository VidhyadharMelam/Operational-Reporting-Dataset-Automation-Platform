# End-to-End Data Pipeline Project (Medallion Architecture + Dashboard)

## Project Flow

### 1. [Data Ingestion](ca://s?q=Data_ingestion_step_in_project_flow)
- Load raw CSV/API data into **Bronze layer**.
- Preserve all records exactly as received (no cleaning yet).

---

### 2. [Data Cleaning](ca://s?q=Data_cleaning_step_in_project_flow)
...
### 3. [Dimensional Modeling](ca://s?q=Dimensional_modeling_step_in_project_flow)
...
### 4. [Gold Layer KPIs](ca://s?q=Gold_layer_KPIs_in_project_flow)
...
### 5. [Dashboard Visualization](ca://s?q=Dashboard_visualization_step_in_project_flow)
...
## Final Deliverable
The **Tableau dashboard** is the final step in the project.  
It presents all KPIs visually, built on top of the Bronze → Silver → Fact → Gold pipeline.
